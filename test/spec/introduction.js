...
//   beforeEach(module('ePlayerServices'));
  ...
  //     $httpBackend.expectGET('data/1.json').
  //         respond([{val1: '1.png', val2: 'Angular.js'}, {val1: '2.png', val2: 'Backbone.js'}]);
 
  //     scope = $rootScope.$new();
  //     ctrl = $controller(oneCtrl, {$scope: scope});
  //   }));
  ...
  //     expect(scope.list1).toEqualData(
  //         [{val1: '1.png', val2: 'Angular.js'}, {val1: '2.png', val2: 'Backbone.js'}]);
  //   });
